#!/usr/bin/env python3
"""
Quick TCP test for XKOP protocol
This mimics what your Windows test program is doing
"""
...
def test_tcp_connection(host: str, port: int):
    """Test TCP connection to XKOP server"""
    ...
    try:
        ...
        print(f"Sending XKOP message: {records}")
        ...
        print(f"Connection successful! Press Ctrl+C to close...")
        try:
            while True:
                import time
                time.sleep(1)
...
if __name__ == "__main__":
    if len(sys.argv) > 1:
        ...
        host = "10.164.95.201"  # Default Raspberry Pi IP
